...
Revision ID: 16583b307700
Revises: 008d4132dadf
Create Date: 2020-12-06 17:02:43.764378
...
revision = '16583b307700'
down_revision = '008d4132dadf'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_index(op.f('ix_w3_db_Sellers_email'), 'Sellers', ['email'], unique=True, schema='w3_db')
